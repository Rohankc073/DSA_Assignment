...
public class AntColonyQ5_a {
    ...
    public AntColonyQ5_a(double[][] distances, int numAnts, int numIterations, double decayFactor, double alpha, double beta) {
    ...
    public static void main(String[] args) {
        ...
        AntColonyQ5_a antColony = new AntColonyQ5_a(distances, numAnts, numIterations, decayFactor, alpha, beta);
        antColony.solve();
